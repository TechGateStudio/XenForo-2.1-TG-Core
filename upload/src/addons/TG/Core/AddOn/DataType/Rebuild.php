...
class Rebuild extends \XF\AddOn\DataType\AbstractDataType
{
	...
	public function getChildTag() : string
	{
		return 'rebuild';
	}

	public function exportAddOnData($addOnId, \DOMElement $container) : bool
	{
		$entries = $this->finder()
	...
	public function importAddOnData($addOnId, \SimpleXMLElement $container, $start = 0, $maxRunTime = 0) : bool
	{
	...
	public function deleteOrphanedAddOnData($addOnId, \SimpleXMLElement $container) : void
	{
	...
	public function rebuildActiveChange(\XF\Entity\AddOn $addOn, array &$jobList) : void
	{
        /*
